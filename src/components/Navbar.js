      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className={`form-check form-switch text-${props.mode === 'light'? 'dark' : 'light'}`}>
            ...
            {/* <input className="form-check-input" onClick={()=>{props.toggleMode(null)}} type="checkbox" aria-checked role="switch" id="flexSwitchCheckDefault" /> */}
...
Navbar.propTypes = {
  title: PropTypes.string.isRequired,  // isRequired makes title mandatory otherwise it gives error if defaultProps are not given
  aboutText: PropTypes.string.isRequired
}


// if no props are passed the it will take below values
Navbar.defaultProps = {
  title: "Title here",
  aboutText: "About"
}
